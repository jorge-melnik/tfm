...
- RF-GUP-13: El sistema debe permitir al usuario gestionar las notificaciones que desea recibir por email seleccionando entre "Me realizaron un pedido", "Me realizaron una pregunta", "Me contestaron una pregunta", "Mi pedido se ingresó correctamente", "Pedido listo para entrega", "Mi pedido está en camino", "Pedido ya retirado o recibido".
- RF-GUP-13: El sistema debe permitir al usuario gestionar las notificaciones que desea en la propia app seleccionando entre "Me realizaron un pedido", "Me realizaron una pregunta", "Me contestaron una pregunta", "Mi pedido se ingresó correctamente", "Pedido listo para entrega", "Mi pedido está en camino", "Pedido ya retirado o recibido".
- RF-GUP-14: El sistema debe permitir al usuario alternar su interfaz entre modo Productor, Consumidor y administrador.
- RF-GUP-15: El sistema debe recordar el rol usado por el usuario en su última sesión (Productor, Consumidor,Admin).
...
- RF-PP-05: El sistema debe proporcionar al productor un mecanismo para ver el historial de pedidos recibidos mostrando bla bla estado,, pago (datos del pago).
  BORRAR: - RF-PP-06: El sistema debe proporcionar al productor un mecanismo para ver el historial de pagos recibidos.
  BORRAR: - RF-PP-07: El sistema debe proporcionar al productor un mecanismo para ver el historial de pedidos entregados.
...
- RF-PP-16: El sistema debe permitir al productor ordenar su catálogo por cantidad vendida en un período seleccionado.
  ...
  -- Grafica cantidades vendidas de cada producto del productor.
