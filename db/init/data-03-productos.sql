...
BEGIN
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_huerta, 4, 'Miel Pura de Monte 1kg', 'miel-pura-monte-1kg', 'Miel cruda de abejas, cosechada de forma artesanal en montes nativos sin agroquímicos.', 450.00, 25, ARRAY['images/miel_1.png', 'images/miel_2.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_huerta, 1, 'Tomate Perita Agroecológico kg', 'tomate-perita-agroecologico-kg', 'Tomates madurados en planta, cultivados con técnicas regenerativas cuidando el suelo.', 120.00, 50, ARRAY['images/tomates.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_huerta, 3, 'Huevos de Campo x12', 'huevos-de-campo-x12', 'Huevos de gallinas libres, criadas a pastoreo e insumos naturales.', 180.00, 15, ARRAY['images/huevos.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_huerta, 17, 'Compost Orgánico Maduro 5kg', 'compost-organico-maduro-5kg', 'Abono orgánico premium ideal para huertas y plantas, excelente retención de nutrientes.', 250.00, 30, ARRAY['images/compost.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_huerta, 6, 'Plantín de Albahaca Criolla', 'plantin-albahaca-criolla', 'Plantines listos para pasar a tierra o maceta, variedades adaptadas localmente.', 80.00, 40, ARRAY['images/albahaca.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_ambos, 15, 'Cuenco de Cerámica Artesanal', 'cuenco-ceramica-artesanal', 'Modelado a mano con arcilla de cañada local, horneado a leña.', 550.00, 8, ARRAY['images/cuenco1.png', 'images/cuenco2.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_ambos, 11, 'Jabón de Caléndula y Oliva', 'jabon-calendula-oliva', 'Jabón corporal saponificado en frío, ideal para pieles sensibles y libre de químicos.', 190.00, 20, ARRAY['images/jabon.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_ambos, 14, 'Canasta de Mimbre Tejida', 'canasta-mimbre-tejida', 'Canasta reforzada tejida a mano con mimbre natural del río.', 720.00, 5, ARRAY['images/canasta.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_ambos, 9, 'Chutney de Manzana Agridulce', 'chutney-manzana-agridulce', 'Acompañamiento agridulce elaborado artesanalmente con frutas locales de estación.', 280.00, 12, ARRAY['images/chutney.png']);
    ...
    INSERT INTO productos (id_productor, id_subcategoria, nombre, slug_producto, descripcion, precio, cantidad_disponible, fotos)
    VALUES (v_id_juan_ambos, 16, 'Tabla para Picar de Olivo', 'tabla-picar-olivo', 'Tabla rústica confeccionada a mano a partir de maderas caídas y tratada con cera de abejas.', 890.00, 4, ARRAY['images/tabla.png']);
    ...
    RAISE NOTICE '¡Productos cargados con éxito para ambos productores!';
END $$;